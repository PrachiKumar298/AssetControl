...
// Hardcoded project credentials — anon key is safe to ship.
// Row Level Security ensures every user only sees their own data.
...
export const dbClient = {
  ...
  auth: {
    ...
    onAuthStateChange: (callback) => {
      if (isSupabaseConfigured) {
        // Return the full { data: { subscription } } shape — App.jsx destructures this
